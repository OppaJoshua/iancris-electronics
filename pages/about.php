        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="bg-white p-8 rounded-lg">
                ...
                <p class="text-gray-700 leading-relaxed">
                    To provide the best quality service for every partner and user, continuously striving for excellence through professionalism and dedication.
                </p>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg">
                ...
                <p class="text-gray-700 leading-relaxed">
                    Supply best quality CCTV cameras, computers, cables, and network devices to achieve complete customer satisfaction.
                </p>
            </div>
