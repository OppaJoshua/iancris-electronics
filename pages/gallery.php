...
// Common Cebu locations mapping
$locationCoords = [
    'Cebu City' => [10.3157, 123.8854],
    'Lapu-Lapu City' => [10.3103, 123.9494],
    'Mandaue City' => [10.3237, 123.9222],
    'Talisay City' => [10.2449, 123.8492],
    'Mactan' => [10.3103, 123.9494],
    'Bohol' => [9.8500, 124.1435],
    'Cebu' => [10.3157, 123.8854],
    'Consolacion' => [10.3939, 123.9558],
    'Minglanilla' => [10.2461, 123.7970],
    'Naga' => [10.2084, 123.7575],
    'Toledo' => [10.3779, 123.6419],
    'Carcar' => [10.1078, 123.6397]
];
...
while ($item = $result->fetch_assoc()) {
    ...
    $coords = [10.3157 + (rand(-100, 100) / 1000), 123.8854 + (rand(-100, 100) / 1000)];
    foreach ($locationCoords as $key => $value) {
        if (stripos($location, $key) !== false) {
            $coords = [$value[0] + (rand(-30, 30) / 1000), $value[1] + (rand(-30, 30) / 1000)];
            break;
        }
    }
